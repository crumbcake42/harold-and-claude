...
- **`command_audit_log`** — single shared table with polymorphic `(entity_type, entity_id)` reference for the 7 audit-log entities. Written by the dispatcher; timing (in-txn vs. post-commit) deferred to implementation phase.
